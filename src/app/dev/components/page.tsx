      ...
      <div className="mx-auto max-w-4xl space-y-12">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            All shadcn components styled to the Chatty design system.
          </p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Chatty leveraged usage data to deliver measurable improvements
                  across global teams.
                </p>
              </CardContent>
              <CardFooter>
        ...
        <Section title="Typography">
          <div className="space-y-3">
            ...
            <h2 className="text-2xl font-semibold tracking-tight">Display 3</h2>
            <h3 className="text-xl font-semibold">Display 4</h3>
            <p className="text-sm leading-relaxed">
              Body text at 14px. This is what most content looks like in the
              Chatty design system. Dense, functional, documentation-grade.
            </p>
          ...
          <Row label="contact items">
            <div className="w-full max-w-xs space-y-0.5 rounded-lg border bg-card p-2">
              {[
                ...
                {
                  name: "Carol",
                  presence: "bg-muted-foreground/40",
                  unread: 2,
                },
              ].map((c) => (
                <div
                ...
                >
                  <span
                    className={`inline-block h-2 w-2 shrink-0 rounded-full ${c.presence}`}
                  />
            ...
            <div className="w-full max-w-xs space-y-1 rounded-lg border bg-card p-2">
              {[
                ...
                >
                  ...
                  <span
                    className={`inline-block h-2 w-2 shrink-0 rounded-full ${m.presence}`}
                  />
                </div>
              ))}
            </div>
